...
export const LaporanRingkasanPenjualan = () => {
    ...
    const [laporanPromo, setLaporanPromo] = useState([])
    const [laporanPelanggan, setLaporanPelanggan] = useState([])
    ...
    useEffect(() => {
        const tanggal = {
        dari: "2025-01-01T00:00:00Z",
        sampai: new Date().toISOString().split(".")[0] + "Z",
        };
    ...
    {/* Fetching Laporan Promo */}
    // useEffect(() => {
    //     const fetchPromo = async () => {
    //         try {
    //             const response = await axios.post("")
    //             console.log(response.data)
    //             setLaporanPromo(response.data)
    //         } catch {
    ...
    {/* Fetching Laporan Pelanggan */}
    // useEffect(() => {
    //     const fetchPromo = async () => {
    //         try {
    //             const response = await axios.post("")
    //             console.log(response.data)
    //             setLaporanPelanggan(response.data)
    //         } catch {
    ...
    return (
        ...
        <div className="flex flex-col">
            ...
            <div className="flex flex-col gap-2 justify-between w-full mt-[5px]">
                ...
                <div
                    className={`absolute h-full px-4 top-2 start-0 w-full ${
                    button ? "" : "opacity-0"
                    }`}
                >
                    <button
                    ...
                    {/* {laporanPromo.map((item, i) => {
                        <div className='flex justify-between text-center items-center border border-[#BDBDBD] rounded-xl p-[15px]'>
                            <div className='grid text-start gap-2'>
                                <p>{item.namapromo}</p>
                                <p>Rp {item.hargaPromo.toLocaleString("id-ID")}</p>
                            </div>
