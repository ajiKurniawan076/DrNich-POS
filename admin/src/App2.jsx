          ...
          <div className="main-content">
            <Routes>
              ...
              <Route element={<ProtectedRoutes />}>
                <Route element={<ProtectedLevel level={[1, 3]} />}>
                ...
                <Route element={<ProtectedLevel level={[1, 2]} />}>
                  ...
                  <Route
                    path="/riwayatsupplier/:id"
                    element={<RiwayatSupplier />}
                  />
                  <Route
                    path="/DaftarProdukSupp/:id"
                    element={<DaftarProdukSupp />}
                  />
                  ...
                  />
                  <Route
                    path="/LaporanLogPelanggan/:id"
                    element={<LaporanLogPelanggan />}
                  />
                  ...
                  <Route
                    path="/DetailProdukSupp/:id"
                    element={<DetailProdukSupp />}
                  />
                  <Route
                    path="/DaftarProdukUpdateSupp/:id"
                    element={<DaftarProdukUpdateSupp />}
                  />
                  <Route
                    path="/PilihPembayaranProduk/:id"
                    element={<PilihPembayaranProduk />}
                  />
                </Route>
